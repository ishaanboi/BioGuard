        ...
        >
            <div className="space-y-8">
                <div className="text-center md:text-left">
                    <h1 className="text-4xl font-headline font-black text-white mb-2 tracking-tight">Welcome Back</h1>
                    <p className="text-blue-200/60 font-medium">Continue your journey to health security.</p>
                </div>
