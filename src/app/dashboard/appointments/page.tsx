...
export default function AppointmentsPage() {
    ...
    return (
        <div className="space-y-6 h-full flex flex-col">
            {!user ? (
                <div className="text-center py-20 mt-10 rounded-2xl border border-dashed border-white/10 bg-white/5 backdrop-blur-sm max-w-2xl mx-auto flex-1 h-full w-full flex-col justify-center">
                    ...
                    <p className="text-blue-200/50 mb-8 max-w-md mx-auto leading-relaxed">
                        Please sign in to search for doctors, view clinic locations, and book your secure medical appointments.
                    </p>
